...
class Web(protocol.Protocol): ### Set custom protocol class name
	...
	def dataReceived(self, data):
		...
		elif request.path in ['/phpmyadmin', '/phpmyadmin/', '/administrator/phpmyadmin', '/administrator/phpmyadmin/', '/sql/myadmin/', '/admin/db/', '/phpmyAdmin/', '/admin/sqladmin/', '/phpmyadmin/scripts/setup.php', '/db/webadmin/', '/sql/myadmin/', '/admin/phpmyadmin/', '/myadmin/', 'administrator/admin/', '/db/webadmin/', '/myadmin/', '/administrator/PMA/']:
