...
class MOTD(protocol.Protocol): ### Set custom protocol class name
	localhost   = None
	remote_host = None
	session     = None
	...
	def connectionMade(self):
		...
		### START CUSTOM CODE ####################################################################
		data = "Prototype unit 0001 is ready to accept programming\r\n"	
		self.tx(data)
...
class pluginFactory(protocol.Factory):
	protocol = MOTD ### Set protocol to custom protocol class name
